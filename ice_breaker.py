...
information = """
Elon Reeve Musk (born June 28, 1971) is a businessman and investor. He is best known for his key roles in space company SpaceX and automotive company Tesla, Inc. Other notable involvements include ownership of X Corp., formerly Twitter, and his role in the founding of The Boring Company, xAI, Neuralink and OpenAI. He is one of the wealthiest people in the world; as of June 2024, Forbes estimates his net worth to be US$210 billion.[4]
...
if __name__ == "__main__":
    print("Welcome to the Ice-Breaker Application!")
    ...
    llm = ChatOpenAI(temperature=0, model_name='gpt-3.5-turbo') # temperature indecates how creative the model would be, and a 0 value means it will not be creative
